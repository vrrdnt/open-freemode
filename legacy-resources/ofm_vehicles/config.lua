return {
    ...
    garages = {
        ...
        alta_street = {
            id = 'alta_street',
            name = 'Alta Street Apartment Garage',
            coords = { x = 275.05, y = -345.52, z = 45.17 },
            spawn = { x = 285.10, y = -342.82, z = 44.92, w = 249.0 },
            radius = 8.0,
            spawnClearRadius = 3.0,
            propertyId = 'alta_street',
        },
        del_perro = {
            id = 'del_perro',
            name = 'Del Perro Apartment Garage',
            coords = { x = -1454.21, y = -653.04, z = 29.52 },
            spawn = { x = -1462.45, y = -661.05, z = 29.02, w = 215.0 },
            radius = 8.0,
            spawnClearRadius = 3.0,
            propertyId = 'del_perro',
        },
    },
    modshop = {
        name = 'Burton Customs',
